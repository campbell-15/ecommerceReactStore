            ...
            <div className="item-in-bag">
              ...
              <div className="content-area">
                ...
                <div className="rating">
                  <div className="stars">
                    <img className="icon" alt="" src="/star-solid.svg" />
                    <img className="icon" alt="" src="/star-solid.svg" />
                    <img className="icon" alt="" src="/star-solid.svg" />
                    <img className="icon" alt="" src="/star-solid.svg" />
                    <img className="icon" alt="" src="/star-half-stroke.svg" />
                  </div>
                  ...
                  <div className="quantity">
                    <div className="price1">
                      <div className="increase-button">
                        <img className="icon2" alt="" src="/minus-solid.svg" />
                        <div className="button4">Button</div>
                      </div>
                      <div className="div3">1</div>
                      <div className="increase-button">
                        <img className="icon2" alt="" src="/plus-solid.svg" />
                        <div className="button4">Button</div>
                      </div>
                    </div>
                  </div>
